...
def resample_school_zones(
    ...
    for univ_code in allowed_univ_codes:
        ...
        choosers.loc[choosers_to_override, col_to_override] = choices
...
def university_location_zone_override(
    ...
    persons[original_zone_col_name].fillna(-9, inplace=True)
...
def trip_destination_univ_zone_override(
    ...
    trips[original_zone_col_name].fillna(-9, inplace=True)
