### Paths
SYSTEM_APP_PATH       <- SCRIPTS_DIR
SYSTEM_PROJECT_PATH   <- WORKING_DIR
...
RUNTIME_PATH          <- file.path(ABM_SUMMARY_DIR, "runtime")
BASE_DATA_PATH        <- file.path(ABM_SUMMARY_DIR, "base")
BUILD_DATA_PATH       <- BUILD_SUMMARY_DIR
BUILD_JPEG_PATH       <- BUILD_SUMMARY_DIR

### Names
if(IS_BASE_SURVEY=="Yes"){
  #   Surey Base
  BASE_SCENARIO_ALT     <- BASE_SCENARIO_NAME
  DISTRICT_FLOW_CENSUS  <- "2019 ACS PUMS Commuting Flows"
...
subsidy_bins          <- c( "0-9", "10-19", "20-29", "30-39", "40-49", "50-59", "60-69", "70-79", "80-89", "90-99", "100")
...
timePeriodBreaks      <- c(1,8,13,24,32,49)
