...
value <- format(cv_trips[, .N], 
                big.mark = ",", trim = TRUE)
valueBox(value, "Total Stops<br>(SEMCOG and Buffer Region)</br>", icon = "fa-map-marker")
```

### Total Stops within SEMCOG

```{r Commercial_Vehicle_Total_Stops_ValueBox_SEMCOG2}
value <- format(cv_trips[DTYPE=="SEMCOG", .N], 
                big.mark = ",", trim = TRUE)
valueBox(value, "Total Stops<br>(SEMCOG Region)</br>", icon = "fa-map-marker")
```

### Light Vehicle Stops within SEMCOG

```{r Commercial_Vehicle_Light_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Vehicle == "Light" & DTYPE=="SEMCOG", .N], big.mark = ",", trim = TRUE)
valueBox(value, "Light Vehicle Stops<br>(SEMCOG Region)</br>", icon = "fa-cube")
```

### Medium Truck Stops within SEMCOG

```{r Commercial_Vehicle_Medium_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Vehicle == "Medium" & DTYPE=="SEMCOG", .N], big.mark = ",", trim = TRUE)
valueBox(value, "Medium Truck Stops<br>(SEMCOG Region)</br>", icon = "fa-wrench")
```

### Heavy Truck Stops within SEMCOG

```{r Commercial_Vehicle_Heavy_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Vehicle == "Heavy"  & DTYPE=="SEMCOG", .N], big.mark = ",", trim = TRUE)
valueBox(value, "Heavy Truck Stops<br>(SEMCOG Region)</br>", icon = "fa-cutlery")
```

### Total Stops Buffer

```{r Commercial_Vehicle_Total_Stops_ValueBox_BUFFER2}
value <- format(cv_trips[DTYPE != "SEMCOG", .N], 
                big.mark = ",", trim = TRUE)
valueBox(value, "Total Stops<br>(Buffer Region)</br>", icon = "fa-map-marker")
```
...
# Organize
dat <- cv_trips[DTYPE == "SEMCOG",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[DTYPE == "SEMCOG" & Vehicle == "Light",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[DTYPE == "SEMCOG" & Vehicle == "Medium",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[DTYPE == "SEMCOG" & Vehicle == "Heavy",.N, keyby = .(County = Region.Destination, Activity)]
...
# Organize
dat <- cv_trips[DTYPE == "SEMCOG",.N, keyby = .(County = Region.Destination, Activity, Vehicle)]
...
# Table
kable(dat, escape=FALSE, nsmall = 0) %>%
...
```{r Commercial_Vehicle_Total_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[DTYPE=="SEMCOG", .N], 
                big.mark = ",", trim = TRUE)
valueBox(value, "Total Stops<br>(SEMCOG Region)</br>", icon = "fa-map-marker")
```

### Goods Stops within SEMCOG

```{r Commercial_Vehicle_Goods_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Activity == "Goods" & DTYPE=="SEMCOG", .N], big.mark = ",", trim = TRUE)
valueBox(value, "Goods Deliveries<br>(SEMCOG Region)</br>", icon = "fa-cube")
```

### Service Stops within SEMCOG

```{r Commercial_Vehicle_Service_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Activity == "Service" & DTYPE=="SEMCOG", .N], big.mark = ",", trim = TRUE)
valueBox(value, "Service Stops<br>(SEMCOG Region)</br>", icon = "fa-wrench")
```

### Intermediate Stops within SEMCOG

```{r Commercial_Vehicle_Intermediate_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Scheduled == 0L & DTYPE=="SEMCOG", .N], big.mark = ",", trim = TRUE)
valueBox(value, "Non-Scheduled Stops<br>(SEMCOG Region)</br>", icon = "fa-cutlery")
```

### Return Stops within SEMCOG

```{r Commercial_Vehicle_Return_Stops_ValueBox_SEMCOG}
value <- format(cv_trips[Activity == "Return" & DTYPE=="SEMCOG", .N], 
                big.mark = ",", trim = TRUE)
valueBox(value, "Return Stops<br>(SEMCOG Region)</br>", icon = "fa-building-o")
```

### Total Stops Buffer

```{r Commercial_Vehicle_Total_Stops_ValueBox_BUFFER}
value <- format(cv_trips[DTYPE != "SEMCOG", .N], 
                big.mark = ",", trim = TRUE)
valueBox(value, "Total Stops<br>(Buffer Region)</br>", icon = "fa-map-marker")
```
...
value <- format(cv_trips[OTYPE == "SEMCOG" | DTYPE == "SEMCOG", uniqueN(TourID)],
                big.mark = ",",  scientific = FALSE, trim = TRUE)
valueBox(value, caption = "Commercial Vehicle Tours (Stop in SEMCOG)", icon = "fa-truck")

```

### Light Vehicle Tours (Stops in SEMCOG)

```{r Commercial_Vehicle_Tours_Light_ValueBox2}

value <- format(cv_trips[(OTYPE == "SEMCOG" | DTYPE == "SEMCOG") & Vehicle == "Light", uniqueN(TourID)],
                big.mark = ",",  scientific = FALSE, trim = TRUE)
valueBox(value, caption = "Light Vehicle Tours (Stop in SEMCOG)", icon = "fa-truck")

```

### Medium Truck Tours (Stops in SEMCOG)

```{r Commercial_Vehicle_Tours_Medium_ValueBox2}

value <- format(cv_trips[(OTYPE == "SEMCOG" | DTYPE == "SEMCOG") & Vehicle == "Medium", uniqueN(TourID)],
                big.mark = ",",  scientific = FALSE, trim = TRUE)
valueBox(value, caption = "Medium Truck Tours (Stop in SEMCOG)", icon = "fa-truck")

```

### Heavy Truck Tours (Stops in SEMCOG)

```{r Commercial_Vehicle_Tours_Heavy_ValueBox2}

value <- format(cv_trips[(OTYPE == "SEMCOG" | DTYPE == "SEMCOG") & Vehicle == "Heavy", uniqueN(TourID)],
                big.mark = ",",  scientific = FALSE, trim = TRUE)
valueBox(value, caption = "Heavy Truck Tours (Stop in SEMCOG)", icon = "fa-truck")
...
### Tour Start Locations by SEMCOG County and Buffer
...
# Plot
bar_plotter(dat, xvar = "Region", yvar = "N", fill = "Vehicle", xlabel = "Tour Start County or Buffer State/Country", ylabel = "Commercial Vehicle Tours", coord_flip = TRUE)
```

> Includes all CV tours including those that start and end in the buffer region and do not include stops inside the SEMCOG region
...
value <- format(cv_trips[, .N], big.mark = ",",  scientific = FALSE, trim = TRUE)
...
value <- format(cv_trips[SKIMTYPE == "Within SEMCOG", .N], big.mark = ",",  scientific = FALSE, trim = TRUE)
...
value <- format(cv_trips[SKIMTYPE == "Buffer to SEMCOG", .N], big.mark = ",",  scientific = FALSE, trim = TRUE)
...
value <- format(cv_trips[SKIMTYPE == "SEMCOG to Buffer", .N], big.mark = ",",  scientific = FALSE, trim = TRUE)
...
value <- format(cv_trips[SKIMTYPE == "Buffer traversing SEMCOG", .N], big.mark = ",",  scientific = FALSE, trim = TRUE)
...
value <- format(cv_trips[SKIMTYPE == "Buffer no traverse", .N], big.mark = ",",  scientific = FALSE, trim = TRUE)
...
### Trip Orgins by County and Buffer
...
# Save
fwrite(dat, file = file.path(SCENARIO_OUTPUT_PATH, "Commercial_Trip_Origins_by_County_Buffer.csv"), row.names = FALSE)
assign("db_tab_cv_trip_origin_county_buffer", dat, envir = db_inputs)

# Plot
bar_plotter(dat, xvar = "Region", yvar = "N", fill = "Vehicle", xlabel = "Trip Origin County or Buffer State/Country", ylabel = "Commercial Vehicle Trips", coord_flip = TRUE)
```

### Trip Destinations by County and Buffer
...
# Save
fwrite(dat, file = file.path(SCENARIO_OUTPUT_PATH, "Commercial_Trip_Destinations_by_County_Buffer.csv"), row.names = FALSE)
assign("db_tab_cv_trip_destination_county_buffer", dat, envir = db_inputs)

# Plot
bar_plotter(dat, xvar = "Region", yvar = "N", fill = "Vehicle", xlabel = "Trip Destination County or Buffer State/Country", ylabel = "Commercial Vehicle Trips", coord_flip = TRUE)
```
...
# Organize
dat <- cv_trips[OTYPE == "SEMCOG",.(.N), keyby = .(County = Region.Origin, TOD, Vehicle)]
dat[, TOD := factor(TOD, levels = names(BASE_TOD_RANGES))]
...
> All trips with origins in a SEMCOG region county
...
<!-- Calibration {data-navmenu="Commercial Vehicle Touring Model"} -->
<!-- ============================================ -->
