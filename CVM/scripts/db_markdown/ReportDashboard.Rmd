...
dat[, (cols) := lapply(.SD, format,  big.mark = ",", nsmall = 0, scientific = FALSE), .SDcols = cols]
...
dat[is.na(dat)] <- 0
cols <- names(dat)[3:ncol(dat)]
dat[, (cols) := lapply(.SD, format, nsmall = 1, digits = 2, big.mark = ",", scientific = FALSE), .SDcols = cols]
