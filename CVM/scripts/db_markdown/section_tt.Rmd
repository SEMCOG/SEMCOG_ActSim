...
Daily trip tables combining trips from the long distance and commercial vehicle touring models for the SEMCOG region (does not include trips wholly within the buffer region).

### Long Distance Model Trips

```{r Trip_Table_LD_Trips_ValueBox_SEMCOG}
value <- format(sum(tmh_vtods[Source == "LD"]$Trips, na.rm = TRUE),  big.mark = ",", digits = 3, nsmall = 0, scientific = FALSE, trim = TRUE)
valueBox(value, "Long Distance<br>Model Trips</br>", icon = "fa-cube")
```

### Commercial Vehicle Touring Model Trips

```{r Trip_Table_CV_Trips_ValueBox_SEMCOG}
value <- format(sum(tmh_vtods[Source == "CV"]$Trips, na.rm = TRUE),  big.mark = ",", digits = 3, nsmall = 0, scientific = FALSE, trim = TRUE)
valueBox(value, "CVTM Trips<br>(SEMCOG Region)</br>", icon = "fa-wrench")
```

### Total Trips within, to, from, and through SEMCOG Region

```{r Trip_Table_Total_Trips_ValueBox_SEMCOG}
value <- format(sum(tmh_vtods$Trips, na.rm = TRUE), 
                 big.mark = ",", digits = 3, nsmall = 0, scientific = FALSE, trim = TRUE)
valueBox(value, "Total Trips<br>(SEMCOG Region)</br>", icon = "fa-map-marker")
```

### Long Distance Model VMT

```{r Trip_Table_LD_VMT_ValueBox_SEMCOG}
value <- format(sum(tmh_vtods[Source == "LD"]$VMT, na.rm = TRUE),  big.mark = ",", digits = 3, nsmall = 0, scientific = FALSE, trim = TRUE)
valueBox(value, "Long Distance<br>Model VMT</br>", icon = "fa-cube")
```

### Commercial Vehicle Touring Model VMT

```{r Trip_Table_CV_VMT_ValueBox_SEMCOG}
value <- format(sum(tmh_vtods[Source == "CV"]$VMT, na.rm = TRUE),  big.mark = ",", digits = 3, nsmall = 0, scientific = FALSE, trim = TRUE)
valueBox(value, "CVTM VMT<br>(SEMCOG Region)</br>", icon = "fa-wrench")
```

### Total VMT in SEMCOG Region

```{r Trip_Table_Total_VMT_ValueBox_SEMCOG}
value <- format(sum(tmh_vtods$VMT, na.rm = TRUE), 
                 big.mark = ",", digits = 3, nsmall = 0, scientific = FALSE, trim = TRUE)
valueBox(value, "Total VMT<br>(SEMCOG Region)</br>", icon = "fa-map-marker")
```
