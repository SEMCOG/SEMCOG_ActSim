...
db_build_spreadsheet <- function(){
  ...
  # Scenario names for sheet names: max 19 chars as _Truck_Trips is 12 and max sheet name is 31 chars
  scenario_1_sheet <- ifelse(nchar(SCENARIO_1) <= 19, SCENARIO_1, substr(SCENARIO_1,1,19))
  scenario_2_sheet <- ifelse(nchar(SCENARIO_2) <= 19, SCENARIO_2, substr(SCENARIO_2,1,19))
  ...
  if(SCENARIO_1 == "Validation"){
    ...
    wb <- addScenarioSummarySheet(wb, 
                                  paste0(scenario_2_sheet, "_Assn_Val"), 
  ...
  if(SCENARIO_2 != SCENARIO_1 & SCENARIO_1 != "Validation") {
    ...
    wb <- addScenarioSummarySheet(wb,
                                  paste0(scenario_1_sheet, "_Truck_Trips"),
  ...
  wb <- addScenarioSummarySheet(wb,
                              paste0(scenario_2_sheet, "_Truck_Trips"),
